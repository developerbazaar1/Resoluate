...
<div class="content content-fixed ">
   <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0  ">
        ...
        @if($project_contract_owner->status == 'negotiation')
            ...
            <span id="ownermsaid" style="display:none">{{ $project_contract_owner->id }}</span>
            ...
            <div class="position-relative">
                ...
                <h4 class="mg-b-0 tx-spacing--1">Comment: Project Contract Owner</h4>
            </div>
        ...
        @else
                ...
                @elseif($project_contract_owner->status == 'request-for-sign')
                <div class="position-relative">
                    <nav aria-label="breadcrumb">
                       <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                          <li class="breadcrumb-item"><a href="#">Project Contract Owner</a></li>
                ...
                @elseif($project_contract_owner->status == 'completed')
                <div class="position-relative">
                    <nav aria-label="breadcrumb">
                       <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                          <li class="breadcrumb-item"><a href="#">Project Contract Owner</a></li>
