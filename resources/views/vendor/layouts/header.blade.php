    ...
    <aside class="aside aside-fixed sidebar-height ">
          ...
          <div class="aside-body bg-gray-900">
            <div class="aside-loggedin">
              ...
              <div class="collapse" id="loggedinMenu">
                <ul class="nav nav-aside mg-b-0">
                    ...
                    @endphp
                  <li class="nav-item"><a href="{{ route('vendor-editprofile', $userid) }}" class="nav-link"><i data-feather="edit"></i> <span>Edit Profile</span></a></li>
                  <li class="nav-item">
            ...
            <ul class="nav nav-aside sidebar-icons">
              <li class="nav-label"><a class="custom-clr" href="{{ route('vendor-dashboard') }}">Dashboard</a></li>
              
              <li class="nav-item icon-list"><a href="{{ route('vendor-all-contracts') }}" class="nav-link"><i class="fa-sharp fas fa-file-signature"></i> <span> All Contracts </span></a></li>
