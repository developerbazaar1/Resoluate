   ...
   <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0  ">
        <!-- <div class=" back-btn">
         ...
         <div class="position-relative">
            ...
            <h4 class="mg-b-0 tx-spacing--1">Edit MSA Template</h4>
        ...
        <form method="POST" action="{{ route('user-update-msa-template') }}" enctype="multipart/form-data">
         @csrf
                           ...
                           <option label="Choose one"></option>
                            @if(count($msa_types) > 0)
                               @foreach($msa_types as $msa_type)
                                 @if ($msa_type->name ==  $m->type_msa_psa )
