         ...
         <div class="tab-content mg-t-20" id="myTabContent5">
            ...
            <div class="tab-pane fade {{ empty($tabName) || $tabName == 'owner-msa' ? 'active show' : '' }}" id="Owner5" role="tabpanel" aria-labelledby="Owner-tab5">
               ...
               <div class="create-new-btn custom-btn">
                  ...
                  <a href="{{ route('user-create-owner-msa') }}">Create New <i class="fas fa-plus"></i></a>
               ...
               <table id="example1" class="table data-table">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        @endphp
                        <td><a class=" btn-sm btn-success"  href="{{ route('user-owner-msa-start-workflow', $ownermsaid) }}" >@php if($owner_msa->status == 'negotiation'){ echo "Comment"; }else{ echo $owner_msa->status; } @endphp </a></td>
            ...
            <div class="tab-pane fade {{ $tabName == 'vendor-msa/psa' ? 'active show' : '' }} " id="Vendor5" role="tabpanel" aria-labelledby="Vendor-tab5">
               ...
               <div class="create-new-btn custom-btn">
                  ...
                  <a href="{{ route('user-create-vendor-msa') }}">Create New <i class="fas fa-plus"></i></a>
               ...
               <table id="example2" class="table data-table">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        @endphp
                        <td><a class="btn-sm btn-success"  href="{{ route('user-vendor-msa-start-workflow', $vendormsaid) }}" >@php if($vendor_msa->status == 'negotiation'){ echo "Comment"; }else{ echo $vendor_msa->status; } @endphp </a></td>
            ...
            <div class="tab-pane fade  {{ $tabName == 'project contract-owner' ? 'active show' : '' }} " id="Project-owner5" role="tabpanel" aria-labelledby="Project-owner-tab5">
               ...
               <div class="create-new-btn custom-btn">
                  ...
                  <a href="{{ route('user-create-project-contract-owner') }}">Create New <i class="fas fa-plus"></i></a>
               ...
               <table id="example3" class="table data-table">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        @endphp
                        <td><a class=" btn-sm btn-success"  href="{{ route('user-project-contract-owner-start-workflow', $pcoid) }}" >@php if($pco->status == 'negotiation'){ echo "Comment"; }else{ echo $pco->status; } @endphp </a></td>
            ...
            <div class="tab-pane fade {{ $tabName == 'project contract-vendor' ? 'active show' : '' }} " id="Project-vendor5" role="tabpanel" aria-labelledby="Project-vendor-tab5">
               ...
               <div class="create-new-btn custom-btn">
                  ...
                  <a href="{{ route('user-create-project-contract-vendor') }}">Create New <i class="fas fa-plus"></i></a>
               ...
               <table id="example4" class="table data-table">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        @endphp
                        <td><a class="btn-sm btn-success"  href="{{ route('user-project-contract-vendor-start-workflow', $pcvid) }}" >@php if($vendor_msa->status == 'negotiation'){ echo "Comment"; }else{ echo $vendor_msa->status; } @endphp </a></td>
