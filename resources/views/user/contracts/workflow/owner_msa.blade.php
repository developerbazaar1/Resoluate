...
<div class="content content-fixed ">
   <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0  ">
        ...
        @if($owner_msa->status == 'start' || $owner_msa->status == 'negotiation' || $owner_msa->status == 'workflow')
            ...
            <div class="position-relative">
                ...
                <div class="create-new-btn custom-btn m-0" style="position:absolute;right: 427px;top: 11px;">
                    ...
                    <a href="{{ URL::asset('/public/'.$owner_msa->document_original) }}" target="_blank"  class="req_for_sign_btn"  style="padding: 15px 30px">View Document</a>
                   
                </div>
                
                <div class="create-new-btn custom-btn m-0" style="position:absolute;right: 240px;top: 11px;">
                  
                    <a href="https://64802b9d957b49395510faf0--eclectic-kashata-047f58.netlify.app/owner-msa/<?php echo $ownermsaid ?>"  class="req_for_sign_btn" style="padding: 15px 30px">Edit Document</a>
                    
                </div>
                <div class="create-new-btn custom-btn m-0" style="position:absolute;right: 0;top: -2px;">
                   
                 <form method="POST" action="{{ route('user-owner-msa-request-signature') }}">
                        @csrf
                            <input type="hidden" name="ownermsaid" value={{$owner_msa->id}}> 
        ...
        @else
            ...
            @if(!empty($owner_msa->documentId))
                    ...
                    @if($owner_msa->status == 'request-for-sign')
                    <div class="position-relative">
                        <nav aria-label="breadcrumb">
                           <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                              <li class="breadcrumb-item"><a href="#">Owner MSA</a></li>
                        ...
                        <h4 class="mg-b-0 tx-spacing--1">Signatureflow: Owner MSA</h4>
                    
                    </div>
                    <iframe
                        id = "prepare_page"
                        src = "{{$owner_msa->sendUrl}}"
                        width = "100%"
                        class = "frame"
                        style="height: 80vh;">
                    </iframe>
