...
<div class="content content-fixed ">
   <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0  ">
        ...
        @if($project_contract_vendor->status == 'start' || $project_contract_vendor->status == 'negotiation' || $project_contract_vendor->status == 'workflow')
            ...
            <span id="pcvid" style="display:none">{{ $project_contract_vendor->id }}</span>
            ...
            <div class="position-relative">
                ...
                <h4 class="mg-b-0 tx-spacing--1">Workflow: Project Contract Vendor</h4>
                @php 
                   $pcvid = Crypt::encrypt($project_contract_vendor->id); 
                @endphp


                <div class="create-new-btn custom-btn m-0" style="position:absolute;right: 427px;top: 11px;">
                  
                    <a href="{{ URL::asset('/public/'.$project_contract_vendor->document_original) }}" target="_blank"  class="req_for_sign_btn"  style="padding: 15px 30px">View Document</a>
                   
                </div>
                
                <div class="create-new-btn custom-btn m-0" style="position:absolute;right: 240px;top: 11px;">
                  
                    <a href="https://64802b9d957b49395510faf0--eclectic-kashata-047f58.netlify.app/project-contract-vendor/<?php echo $pcvid ?>"  class="req_for_sign_btn" style="padding: 15px 30px">Edit Document</a>
                    
                </div>
                <div class="create-new-btn custom-btn m-0" style="position:absolute;right: 0;top: -2px;">
                   
                 <form method="POST" action="{{ route('user-project-contract-vendor-request-signature') }}">
                        @csrf
                            <input type="hidden" name="pcvid" value={{$project_contract_vendor->id}}> 
        ...
        @else
            ...
            @if(!empty($project_contract_vendor->documentId))
                    ...
                    @if($project_contract_vendor->status == 'request-for-sign')
                    <div class="position-relative">
                        <nav aria-label="breadcrumb">
                           <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                              <li class="breadcrumb-item"><a href="#">Project Contract Vendor</a></li>
                    ...
                    <iframe
                        id = "prepare_page"
                        src = "{{$project_contract_vendor->sendUrl}}"
                        width = "100%"
                        class = "frame"
                        style="height: 80vh;">
                    </iframe>
                    ...
                    @if($project_contract_vendor->status == 'completed')
                    <div class="position-relative">
                        <nav aria-label="breadcrumb">
                           <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                              <li class="breadcrumb-item"><a href="#">Project Contract Vendor</a></li>
        ...
        document.addEventListener("adobe_dc_view_sdk.ready", function () {
            ...
            adobeDCView.registerCallback(
                ...
                function (metaData, content, options) {
                    ...
                    formData.append('pcvid', $("#pcvid").html());
                    ...
                    $.ajax({
                        url:"{{url('/user/save-workflow/project-contract-vendor')}}",
                        contentType: false,
                        processData: false,
                        data: formData,
                        type: 'POST',
